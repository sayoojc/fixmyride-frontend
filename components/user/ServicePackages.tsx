...
export const ServicePackages = () => {
  ...
  if (!servicePackages || servicePackages.length === 0) {
    return <div className="lg:col-span-2 space-y-6">Loading service packages...</div>
  }
    ...
    <div className="lg:col-span-2 space-y-6">
      {servicePackages.map((service) => (
        <div key={service._id} className="bg-white rounded-lg shadow-md overflow-hidden">
          <div
            className={`px-2 py-1 text-white w-max ${service._id === "683693d245f412053dec2c98" ? "bg-green-500" : "hidden"}`}
          >
            RECOMMENDED
          </div>
          <div className="p-4">
